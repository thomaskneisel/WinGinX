...
class phpDocumentor_setup
{
    ...
    function readConfigFile($file)
    {
        ...
        {
            if ('C:\xampp\php\data' != '@'.'DATA-DIR@')
            {
                $configdir = str_replace('\\','/', 'C:\xampp\php\data/PhpDocumentor') . PATH_DELIMITER . 'user' . PATH_DELIMITER;
            } else {
    ...
    function parseIni()
    {
        ...
        if ('C:\xampp\php\data' != '@'.'DATA-DIR@')
        {
            $options = phpDocumentor_parse_ini_file(str_replace('\\','/', 'C:\xampp\php\data/PhpDocumentor') . PATH_DELIMITER . 'phpDocumentor.ini',true);
            phpDocumentor_out("   (found in " . 'C:\xampp\php\data/PhpDocumentor' . PATH_DELIMITER . ")...\n");
        } else {
