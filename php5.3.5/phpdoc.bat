...
IF '%1'=='' (
  ...
  "%phpCli%" -d include_path="C:\xampp\php\pear" "C:\xampp\php\phpdoc" %*
  GOTO :EOF
)
...
SET count=0
FOR /R "C:\xampp\php\data\PhpDocumentor\user" %%I IN (*.ini) DO (
  SET /a count+=1
...
ECHO.
"%phpCli%"  -d include_path="C:\xampp\php\pear" "C:\xampp\php\phpdoc" -c "%iniFile%"
GOTO :EOF
