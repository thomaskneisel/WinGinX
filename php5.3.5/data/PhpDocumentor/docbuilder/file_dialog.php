...
if ('C:\xampp\php\data' != '@'.'WEB-DIR@')
{
    ...
    */
    ...
    require_once( 'C:\xampp\php\data' . PATH_DELIMITER . 'PhpDocumentor/docbuilder/includes/utilities.php' );
    ...
    $ini = phpDocumentor_parse_ini_file('C:\xampp\php\data' . PATH_DELIMITER . 'PhpDocumentor/phpDocumentor.ini', true);
    if (isset($ini['_phpDocumentor_options']['userdir'])) {
        $configdir = $ini['_phpDocumentor_options']['userdir'];
    } else {
        $configdir = 'C:\xampp\php\data' . PATH_DELIMITER . 'PhpDocumentor/user';
    }
} else {
